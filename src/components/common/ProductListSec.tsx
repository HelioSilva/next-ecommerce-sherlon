      ...
      >
        ...
        {viewAllLink && (
          <div className="w-full px-4 sm:px-0 text-center">
            <Link
              href={viewAllLink}
              className="w-full inline-block sm:w-[218px] px-[54px] py-4 border rounded-full hover:bg-[#685048] hover:text-white text-black transition-all font-medium text-sm sm:text-base border-[#685048/10]"
            >
              Ver todos
            </Link>
          </div>
